...
echo "  3. Install/rewrite systemd units through deploy (do not raw-copy templates on custom install dirs):"
echo "     KAOS_MANAGE_SYSTEMD=true bash scripts/deploy.sh --first-run"
echo "  4. Start agents:"
